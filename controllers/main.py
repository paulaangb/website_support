...
class SupportTicketController(http.Controller):
    ...
    def support_portal_ticket_view(self, portal_access_key):
        ...
        support_ticket = http.request.env['website.support.ticket'].sudo().search([('ticket_number','=',portal_access_key) ])[0]
    ...
    def support_portal_ticket_comment(self, **kw):
        ...
        support_ticket = http.request.env['website.support.ticket'].sudo().search([('ticket_number','=', values['portal_access_key'] ) ])[0]
        ...
        return werkzeug.utils.redirect("/support/portal/ticket/view/" + str(support_ticket.ticket_number) )
